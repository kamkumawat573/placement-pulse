...
export default function EnrollPage() {
  ...
  useEffect(() => {
    ...
    // Load Razorpay Checkout script (avoid duplicates)
    let script = document.getElementById('razorpay-checkout-script') as HTMLScriptElement | null
    ...
    return () => {
      // Cleanup Razorpay script only if we added it here
      if (addedScript) {
